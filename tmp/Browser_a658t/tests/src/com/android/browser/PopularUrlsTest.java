...
public class PopularUrlsTest extends ActivityInstrumentationTestCase2<BrowserActivity> {
    ...
    BufferedReader getInputStream(String inputFile) throws IOException {
        InputStreamReader fileReader = new InputStreamReader(getInstrumentation().getContext().getAssets().open("popular_urls.txt"));
