...
public class BrowserHistoryPage extends Fragment
    ...
    public void onPrepareOptionsMenu(Menu menu) {
    	...
    	boolean clear = Browser.canClearHistory(getActivity().getContentResolver());
    	menu.findItem(R.id.clear_history_menu_id).setVisible(clear);
    	menu.findItem(R.id.clear_today_history_menu_id).setEnabled(clear);
     }
    ...
    void promptToClearTodayHistory(){
        final ContentResolver resolver = getActivity().getContentResolver();
        final ClearTodayHistoryTask clear = new ClearTodayHistoryTask(resolver);
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
    ...
    static class ClearTodayHistoryTask extends Thread {
        ContentResolver mResolver;

        public ClearTodayHistoryTask(ContentResolver resolver) {
            mResolver = resolver;
        }
        ...
        public void run() {
            ...
            deleteHistoryTimeFrame( mResolver , 
    ...
    private static final void deleteHistoryWhere(ContentResolver cr, String whereClause) {
        ...
        try {
            ...
            Log.e("FileManager", "deleteHistoryWhere", e);
            return;
        } finally {
    ...
    static class ClearHistoryTask extends Thread {
        ...
        @Override
        public void run() {
                  deleteHistoryWhere(mResolver, null);
        }
    }
