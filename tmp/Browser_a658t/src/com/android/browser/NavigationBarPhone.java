...
public class NavigationBarPhone extends NavigationBarBase implements
    ...
    protected void onFinishInflate() {
        ...
        url = (UrlInputView)findViewById(R.id.url);
    ...
    public void Gotourl(){
        ...
        mStopButton.setContentDescription(mRefreshDescription);
        mComboIcon.setVisibility(View.GONE);
        onStateChanged(StateListener.STATE_HIGHLIGHTED);
    ...
    public void onStateChanged(int state) {
        ...
        case StateListener.STATE_NORMAL:
            ...
            // Since we have both menu key and menu button in tool bar, just hide
            // the menu action bution
