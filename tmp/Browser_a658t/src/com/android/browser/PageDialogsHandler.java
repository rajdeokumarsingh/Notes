...
public class PageDialogsHandler {
    ...
    void showPageUrl(final Tab tab){
        ...
        AlertDialog.Builder alertDialogBuilder =
                ...
                .setTitle(R.string.page_info_Url)
    ...
    /*private AlertDialog.Builder createSslCertificateDialog(SslCertificate certificate,
            SslError error) {
        View certificateView = certificate.inflateCertificateView2(mContext);
        final LinearLayout placeholder =
                (LinearLayout)certificateView.findViewById(pekall.res.R.id.placeholder2);
