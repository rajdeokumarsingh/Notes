...
public class GeneralPreferencesFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("GeneralPreferencesFragment", "onCreate:");
        ...
        int preference_id = R.xml.general_preferences_w;
        // Load the XML preferences file
        if(BrowserSettings.CMCC_PLATFORM){
            preference_id = R.xml.general_preferences;
        }
    ...
    private static String mEditText;

    private static void clearEditData() {
        mDialog = null;
        mEdit = null;
        mEditText = null;
    }
    ...
    public void onDestroy () {
        Log.i("GeneralPreferencesFragment", "onDestroy");
        if(mDialog != null && mDialog.isShowing()) {
            Log.i("GeneralPreferencesFragment", "onDestroy, dismiss dialog");
        ...
        final AlertDialog dialog = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.ok, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        boolean smartUrl = UrlUtils.ISSmartUrl(homepage);
                        homepage = UrlUtils.smartUrlFilter(homepage);
                        if(!smartUrl){
                            editText.setText(R.string.match_url);
                            try { 
