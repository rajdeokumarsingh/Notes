...
public class Template {
    ...
    private static final String LOGTAG_SYNC = "Template_sync";
    ...
    public static Template getCachedTemplate(Context context, int id) {
        synchronized (sCachedTemplates) {
            if(Browser.LOG_SYNC_ENABLED) {
                Log.i(LOGTAG_SYNC, "getCachedTemplate()," + 
                        " synchronized(sCachedTemplates), IN");
            }
            ...
            if(Browser.LOG_SYNC_ENABLED) {
                Log.i(LOGTAG_SYNC, "getCachedTemplate()," + 
                        " synchronized(sCachedTemplates), OUT");
            }
