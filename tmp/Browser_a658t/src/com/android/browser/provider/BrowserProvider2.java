/*
O * Copyright (C) 2010 he Android Open Source Project
 *
...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    private static final String LOGTAG_SYNC = "BrowserProvider2_sync";
    ...
    public static interface Properties {
        public static final Uri CONTENT_URI = Uri.parse("content://browser/properties");
        public static final String _ID = "_id";
    ...
    public static interface Agents{
        public static final Uri CONTENT_URI = Uri.withAppendedPath(
                BrowserContract.AUTHORITY_URI, "agents");
        public static final String _ID = "_id";
        public static final String AGENT = "agent";
        public static final String PORT = "port";
    }
    
    public static interface NavScreen{
        public static final Uri CONTENT_URI = Uri.withAppendedPath(
                BrowserContract.AUTHORITY_URI, "nav_screen");
        public static final String _ID = "_id";
        public static final String TITLE = "title";
        public static final String URL = "url";
    ...
    static final String TABLE_GLOBAL_INFO = "global_info";
    ...
    static final String TABLE_SCREEN = "nav_screen";
    ...
    public static final String  GLOBAL_INFO_URI = "content://browser/global_info";
    public static final String  COLUMN_BASE_URL = "url";
    public static final String  COLUMN_DOWNLOAD_DIR = "download_dir";
    public static final String  COLUMN_WIFI_OPT = "wifi_close_operation";
    ...
    private static final String[] SUGGEST_PROJECTION = new String[] {
            ...
            bookmarkOrHistoryLiteral(Combined.URL,
                    Integer.toString(R.drawable.ic_search_category_bookmark),
                    Integer.toString(R.drawable.ic_search_category_history)),
            qualifyColumn(TABLE_HISTORY, History.DATE_LAST_VISITED)};
    
    private static final String[] SUGGEST_PROJECTION_BOOKMARK = new String[] {
    	Bookmarks._ID, Bookmarks.URL, Bookmarks.TITLE, 
    	Integer.toString(R.drawable.ic_search_category_bookmark),Bookmarks.DATE_MODIFIED
    };
    private static final String[] SUGGEST_PROJECTION_HISTORY = new String[] {
    	History._ID, History.URL, History.TITLE, 
    	Integer.toString(R.drawable.ic_search_category_history),History.DATE_LAST_VISITED
    };
    public static final String[] SCREEN_PROJECTION = new String[]{
        NavScreen._ID, NavScreen.TITLE, NavScreen.DATE, NavScreen.DATA
    };
    ...
    private static final String SUGGEST_SELECTION_BOOKMARK = "url like ? OR url like ? OR url like ? OR url like ? OR url like ? OR title like ? ";
    ...
    private static final String SUGGEST_BOOKMARK_ORDER_BY = Bookmarks.DATE_MODIFIED + "DESC";
    ...
    static final int ONTEM_PROPERTIES = 1011;
    static final int NAV_SCREEN = 1010;
    static final int GLOBAL_INFO = 1008;
    static final int AGENT = 1009;
    ...
    static {
        ...
        //ontim need
        matcher.addURI("browser", "properties", ONTEM_PROPERTIES);
        
        matcher.addURI("browser", "nav_screen", NAV_SCREEN);
        matcher.addURI(authority, "nav_screen", NAV_SCREEN);
        matcher.addURI(authority, "nav_screen/#", NAV_SCREEN);
        
        matcher.addURI("browser", "global_info", GLOBAL_INFO);
        matcher.addURI(authority, "global_info", GLOBAL_INFO);
        matcher.addURI(authority, "global_info/#", GLOBAL_INFO);
        
        matcher.addURI(authority, "agents", AGENT);
        matcher.addURI(authority, "agents/#", AGENT);
    ...
    final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            // TODO indices
            db.execSQL("CREATE TABLE global_info (" +
                    "_id INTEGER PRIMARY KEY," +
                    "url TEXT," +
                    "download_dir TEXT," +
                    "wifi_close_operation INTEGER" +
                    ");");
            
            db.execSQL("CREATE TABLE omnibox_suggestions (" +
                    "_id INTEGER PRIMARY KEY," +
                    "title TEXT," +
                    "url TEXT," +
            ...
            final CharSequence[] baseUrls = mContext.getResources()
                    .getTextArray(R.array.pref_search_engine_base_urls);
 
            String download_dir = mContext.getResources().getString(
                               R.string.pref_default_download_path);

            db.execSQL("INSERT INTO global_info (_id, url, download_dir, wifi_close_operation)" +
                " VALUES('0', '" + baseUrls[0] + "', '" + download_dir + "', '0');");
            ...
            db.execSQL("CREATE TABLE " + TABLE_AGENTS + " (" +
                    Agents._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"+
                    Agents.AGENT + " TEXT ," +
                    Agents.PORT + " TEXT " +
                    ");");

            db.execSQL("INSERT INTO agents (_id, agent, port)" +
                " VALUES('0','','');");
            ...
            addDefaultOmniboxSuggestions(db);
            updateDefaultScreen(db);
            insertProperties(db);
        }

        void insertProperties(SQLiteDatabase db){
            String sFactoryResetUrl = null;        
            if(BrowserSettings.CUST_HOME_PAGE != null && BrowserSettings.CUST_HOME_PAGE.length() != 0) {
                sFactoryResetUrl = BrowserSettings.CUST_HOME_PAGE;
            } else {
            ...
            db.execSQL("INSERT INTO properties (_id, name, value)" +
                    " VALUES('0', 'homepage','" + sFactoryResetUrl +"');");
        } 
        void updateDefaultScreen(SQLiteDatabase db){
            Resources res = getContext().getResources();
            if(!BrowserSettings.CMCC_PLATFORM){
                String[] screenSites = res.getStringArray(R.array.screen_websites);
                Bitmap bitmap = null;
                for(int i = 0; i <screenSites.length; i = i+2){
                    switch (i) {
                    case 0:
                        bitmap = BitmapFactory.decodeResource(res, R.drawable.home_icon_0);
                        break;
                    case 2:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_2);
                        break;
                    case 4:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_4);
                        break;
                    case 6:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_6);
                        break;    
                    case 8:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_8);
                        break;    
                    case 10:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_10);
                        break;    
                    case 12:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_12);
                        break; 
                    case 14:
                        bitmap = BitmapFactory.decodeResource(res,R.drawable.home_icon_14);
                        break;  
                    ...
                    if(bitmap!=null){
                        ...
                        values.put(NavScreen.TITLE, screenSites[i]);
                        values.put(NavScreen.URL, screenSites[i+1]);
                        values.put(NavScreen.UPDATE, 0);
                        values.put(NavScreen.DATA, os.toByteArray());
                        values.put(NavScreen.DATE, now);
                        long id = db.insert(TABLE_SCREEN, null, values);
                    }
                }
            }
            ContentValues add = new ContentValues();
            String now = Long.toString(System.currentTimeMillis());
            add.put(NavScreen.TITLE, res.getString(R.string.add_new_quick_navigation));
            add.put(NavScreen.UPDATE, 1);
            add.put(NavScreen.DATE, now);
            long id = db.insert(TABLE_SCREEN, null, add);
        }
        ...
        private void addDefaultBookmarks(SQLiteDatabase db, long parentId) {
            ...
            } else if (BrowserSettings.LENOVO_TEST){
                bookmarks = res.getTextArray(R.array.bookmarks_lenovo_test);
            } else if(BrowserSettings.CMCC_PLATFORM && BrowserSettings.CMCC_JICAI){
            	bookmarks = res.getTextArray(R.array.bookmarks_jicai);
            } else if (BrowserSettings.CMCC_PLATFORM) {
                bookmarks = res.getTextArray(R.array.bookmarks); 
            } else {
                bookmarks = res.getTextArray(R.array.bookmarks_w); 
            }
        ...
        private void addDefaultOmniboxSuggestions(SQLiteDatabase db){
            Resources res = getContext().getResources();
            CharSequence[] website1 = null;
            CharSequence[] website2 = null;
            CharSequence[] website3 = null;
            if(BrowserSettings.CU_PLATFORM) { 
                website1 = res.getTextArray(R.array.bookmarks);
                website2 = res.getTextArray(R.array.bookmarks_w);
            } else if (BrowserSettings.CMCC_PLATFORM) {
                website1 = res.getTextArray(R.array.bookmarks_cu);
                website2 = res.getTextArray(R.array.bookmarks_w);
                
            } else {
                website1 = res.getTextArray(R.array.bookmarks_w); 
            }
            website3 = res.getTextArray(R.array.some_websites);

            int size = 0;          
            try {
                if(website1!=null){
                    size = website1.length;
                    if(size > 0){
                        insertOmniboxSuggestions(size, website1, db);
                    }
                }
                if(website2!=null){
                    size = website2.length;
                    if(size > 0){
                        insertOmniboxSuggestions(size, website2, db);
                    }
                }
                if(website3!=null){
                    size = website3.length;
                    if(size > 0){
                        insertOmniboxSuggestions(size, website3, db);
                    }
                }
            } catch (ArrayIndexOutOfBoundsException e) {
            }
        }
        private String Omnibox_title = "title";
        private String Omnibox_url = "url";
        private String Omnibox_bookmark = "bookmark";
        private String Omnibox_visits = "visits";
        private String Omnibox_date = "date";
        private void insertOmniboxSuggestions(int size, CharSequence[] charS, SQLiteDatabase db){
            try {
                String now = Long.toString(System.currentTimeMillis());
                for (int i = 0; i < size; i = i + 2) {
                    CharSequence bookmarkDestination = replaceSystemPropertyInString(getContext(),
                            charS[i + 1]);
                    db.execSQL("INSERT INTO omnibox_suggestions (" +
                            Omnibox_title + ", " +
                            Omnibox_url + ", " +
                            Omnibox_bookmark + "," +
                            Omnibox_visits + "," +
    ...
    public SQLiteOpenHelper getDatabaseHelper(Context context) {
        synchronized (this) {
            if(com.android.browser.Browser.LOG_SYNC_ENABLED) {
                Log.i(LOGTAG_SYNC, "getDatabaseHelper()," + 
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case GLOBAL_INFO: {
            	return db.query(TABLE_GLOBAL_INFO, projection, selection, selectionArgs, null, null, null);
            }
            
            case AGENT:{
                return db.query(TABLE_AGENTS, projection, selection, selectionArgs, null, null, null);
            }

            case NAV_SCREEN:{
                Cursor screen = db.query(TABLE_SCREEN, projection, selection, selectionArgs, null, null, sortOrder);
                screen.setNotificationUri(getContext().getContentResolver(), NavScreen.CONTENT_URI);
                return screen;
            }
            
            case ONTEM_PROPERTIES:{
                return db.query(TABLE_PROPERTIES, projection, selection, selectionArgs, null, null, null);
            }
...
//                selection = SUGGEST_SELECTION;
                selection = SUGGEST_SELECTION_BOOKMARK;
            }
            selection = DatabaseUtils.concatenateWhere(selection,
...
//                SUGGEST_ORDER_BY, null);
        ...
        cursors[0] = mOpenHelper.getReadableDatabase().query(TABLE_BOOKMARKS,
                SUGGEST_PROJECTION_BOOKMARK, selection, selectionArgs, null, null,
                null , null);
        cursors[1] = mOpenHelper.getReadableDatabase().query(TABLE_HISTORY,
                SUGGEST_PROJECTION_HISTORY, SUGGEST_SELECTION_BOOKMARK, selectionArgs, null, null,
                null , null);
    ...
    public int deleteInTransaction(Uri uri, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case AGENT:{
                deleted = db.delete(TABLE_AGENTS, selection, selectionArgs);
                break;
            }
            
            case NAV_SCREEN:{
                deleted = db.delete(TABLE_SCREEN, selection, selectionArgs);
           //     getContext().getContentResolver().notifyChange(NavScreen.CONTENT_URI, null);
                break;
            }
            default: {
    ...
    public Uri insertInTransaction(Uri uri, ContentValues values, boolean callerIsSyncAdapter) {
        ...
        switch (match) {
            ...
            case NAV_SCREEN:{
                id = db.insert(TABLE_SCREEN, null, values);
             //   getContext().getContentResolver().notifyChange(NavScreen.CONTENT_URI, null);
                break;
            }
    ...
    public int updateInTransaction(Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            ...
            case GLOBAL_INFO: {
                modified = db.update(TABLE_GLOBAL_INFO, values, selection, selectionArgs);
            	break;
            }

            case AGENT:{
                modified = db.update(TABLE_AGENTS, values, selection, selectionArgs);
                break;
            }
            
            case NAV_SCREEN:{
                modified = db.update(TABLE_SCREEN, values, selection, selectionArgs);
           //     getContext().getContentResolver().notifyChange(NavScreen.CONTENT_URI, null);
                break;
            }
            
            case ONTEM_PROPERTIES:{
                modified = db.update(TABLE_PROPERTIES, values, selection, selectionArgs);
                break;
            }
    ...
    private static final String SQL_CREATE_VIEW_OMNIBOX_SUGGESTIONS =
            ...
            + "  FROM omnibox_suggestions "
            + "  WHERE url NOT IN (SELECT url FROM bookmarks WHERE deleted = 0 AND folder = 0)"
            + "  UNION ALL "
            + "  SELECT _id, url, title, 0 AS bookmark, visits, date "
            + "  FROM history "
            + "  WHERE url NOT IN ((SELECT url FROM bookmarks"
            + "    WHERE deleted = 0 AND folder = 0) AND (SELECT url FROM omnibox_suggestions)) "
