...
class TabControl {
    ...
    void addPreloadedTab(Tab tab) {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter addPreloadedTab()");
    ...
    SnapshotTab createSnapshotTab(long snapshotId) {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter createSnapshotTab()");
    ...
    void removeParentChildRelationShips() {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter removeParentChildRelationShips()");
    ...
    boolean removeTab(Tab t) {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter removeTab()");
        ...
        mTabQueue.remove(t);
        mController.getUi().getMainMenuControlPhone().populateMenu();
        return true;
    }
     ...
     */
    void freeMemory() {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter freeMemory()");
    ...
    private Vector<Tab> getHalfLeastUsedTabs(Tab current) {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter getHalfLeastUsedTabs()");
    ...
    Tab getLeastUsedTab(Tab current) {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter getLeastUsedTab()");
     ...
     */
    void stopAllLoading() {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter stopAllLoading()");
    ...
    void recreateWebView(Tab t) {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter recreateWebView()");
    ...
    private WebView createNewWebView() {
        if(ENABLE_LOG) Log.v(LOGTAG, "enter createNewWebView()");
    ...
    public void setOnThumbnailUpdatedListener(OnThumbnailUpdatedListener listener) {
        // if(ENABLE_LOG) Log.v(LOGTAG, "enter setOnThumbnailUpdatedListener()");
    ...
    public OnThumbnailUpdatedListener getOnThumbnailUpdatedListener() {
        // if(ENABLE_LOG) Log.v(LOGTAG, "enter getOnThumbnailUpdatedListener()");
