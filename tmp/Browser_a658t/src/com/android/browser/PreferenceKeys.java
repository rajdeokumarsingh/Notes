...
public interface PreferenceKeys {
    ...
    static final String PREF_LOAD_PAGE2 = "load_page2";
    ...
    static final String PREF_DOWNLOAD_DIR_NEW = "download_dir_new";
    static final String PREF_DATA_CONNECTION = "data_connection";
    static final String PREF_DOWNLOAD_DIR_OLD = "download_dir_old";
    ...
    static final String PREF_SETTING_AGENT = "setting_agent";
    static final String PREF_SETTING_IP = "ip";
    static final String PREF_SETTING_PORT = "port";
    static final String PRE_SAVE_AGENT = "pref_save_agent";
    static final String PREF_SETTING_AGENT_CHOOSE = "setting_agent_choose";
    
    static final String PREF_NIGHTMODE = "night";
    static final String PREF_ROTARY = "rotary";
    
    static final String PREF_PAGE_FLIP = "page_filp";
    static final String PREF_LOAD_START_TIME = "load_time";
    static final String PREF_LOAD_END_TIME = "end_time";
    
    static final String PREF_FLOW_START_RX ="rxStart";
    static final String PREF_FLOW_START_TX ="txStart";
}
