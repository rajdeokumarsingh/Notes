...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        } else if (action.equals(Constants.ACTION_TOAST)){
            handlerDownloadCompleteToast(context, intent);
        }
    }

    private void handlerDownloadCompleteToast(Context context, Intent intent) {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (Downloads.Impl.isStatusCompleted(status)
                    ...
                    Toast.makeText(context, context.getResources().
                            getString(R.string.download_success_toast).replace("%s", filename),
