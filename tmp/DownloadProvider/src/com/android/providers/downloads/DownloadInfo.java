...
public class DownloadInfo {
    ...
    public static class Reader {
        private static final String LOGTAG = "DownloadInfo.Reader";
    ...
    public int checkCanUseNetwork() {
        ...
        if(mAllowedNetworkTypes == Constants.NETWORK_MOBILE_INTERNET ||
                mAllowedNetworkTypes == Constants.NETWORK_MOBILE_WAP) {
            return NETWORK_OK;
        }
