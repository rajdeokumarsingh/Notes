...
public class TunedStation extends Station {
    ...
    private Text rt = new Text(64);  // version A
    // PEKALL begin: Sometime RT A/B are overlapping, it is difficult
    // to get completed RT. Just using two Text for RT A/B each
    private Text rtB = new Text(64); // version B
    // PEKALL end
