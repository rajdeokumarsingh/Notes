...
public class Helpers {
    ...
    public static boolean isSpecialNetworkType(int type) {
        return (type == DownloadManager.Request.NETWORK_MOBILE_INTERNET ||
                type == DownloadManager.Request.NETWORK_MOBILE_WAP);
    }
