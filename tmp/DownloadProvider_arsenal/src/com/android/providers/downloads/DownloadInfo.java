...
public class DownloadInfo {
    static final String LOGTAG = "DownloadInfo";

    public static class Reader {
        static final String LOGTAG = "DownloadInfo.Reader";
    ...
    public void sendIntentIfRequested() {
        ...
        Intent toast = new Intent(Constants.ACTION_TOAST);
        toast.setClassName("com.android.providers.downloads",
                DownloadReceiver.class.getName());
        toast.setData(getAllDownloadsUri());
        mContext.sendBroadcast(toast);
    }
    ...
    public long restartTime(long now) {
        Log.i(LOGTAG, "restartTime, now: " + now + ", failed number: "
                + mNumFailed + ", retry after: " + mRetryAfter);
    ...
    private boolean isReadyToStart(long now) {
        Log.i(LOGTAG, "isReadyToStart: " + toString());
    ...
    public int checkCanUseNetwork() {
        ...
        if (Constants.LOGV) {
            Log.v(Constants.TAG, "checkCanUseNetwork, net info: " +
                    ((info == null) ? "" : info.toString()) );
        }
        // TODO: NOT a good way, need investigate later
        if(mAllowedNetworkTypes == DownloadManager.Request.NETWORK_MOBILE_INTERNET ||
                mAllowedNetworkTypes == DownloadManager.Request.NETWORK_MOBILE_WAP) {
            return NETWORK_OK;
        }
    ...
    public String toString() {
        return "DownloadInfo{" +
                ...
                ", mControl=" + mControl +
                ", mStatus=" + mStatus +
                ", mNumFailed=" + mNumFailed +
                ", mRetryAfter=" + mRetryAfter +
                ", mLastMod=" + mLastMod +
                ", mPackage='" + mPackage + '\'' +
                ", mClass='" + mClass + '\'' +
                ", mExtras='" + mExtras + '\'' +
                ...
                ", mETag='" + mETag + '\'' +
                ", mUid=" + mUid +
                ", mMediaScanned=" + mMediaScanned +
                ", mDeleted=" + mDeleted +
                ", mMediaProviderUri='" + mMediaProviderUri + '\'' +
                ", mIsPublicApi=" + mIsPublicApi +
                ", mAllowedNetworkTypes=" + mAllowedNetworkTypes +
                ", mAllowRoaming=" + mAllowRoaming +
                ", mAllowMetered=" + mAllowMetered +
                ", mTitle='" + mTitle + '\'' +
                ", mDescription='" + mDescription + '\'' +
                ", mBypassRecommendedSizeLimit=" + mBypassRecommendedSizeLimit +
                ", mFuzz=" + mFuzz +
