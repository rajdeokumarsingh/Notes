...
class StorageManager {
    ...
    private final File mExternalStorageDirT;
    ...
    private StorageManager(Context context) { // constructor is private
        ...
        mExternalStorageDirT = new File("/storage/sdcard1");
        ...
        switch (destination) {
            ...
            case Downloads.Impl.DESTINATION_FILE_URI:
                if (path.startsWith(mExternalStorageDir.getPath())) {
                    ...
                    dir = mSystemCacheDir;
                } else if(path.startsWith(mExternalStorageDirT.getPath())){
                    dir = mExternalStorageDirT;
                }
                break;
         }
        if (dir == null) {
