...
public class Constants {
    ...
    public static final String TAG = "DownloadConstants";
    ...
    public static final String ACTION_TOAST = "android.intent.action.DOWNLOAD_T_COMPLETE";
    ...
    public static final int MAX_REDIRECTS = 30; // can't be more than 7.
