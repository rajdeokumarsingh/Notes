    ...
    /*package */ static void onDownloadStartNoStream(Activity activity,
        ...
        if(mimetype == null){
            ...
            */
            ...
            new FetchUrlMimeType(activity, privateBrowsing, url, userAgent, referer, false).start(); 
             // PEKALL end
         }else if (mimetype.contains("application/vnd.android.package-archive")){
             new FetchUrlContentLength(activity, privateBrowsing, url, userAgent, mimetype, referer,filename).start(); 
         }else {
