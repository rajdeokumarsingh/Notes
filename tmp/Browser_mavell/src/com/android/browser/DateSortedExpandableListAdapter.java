...
public class DateSortedExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private int mNumberOfBins = DateSorter.DAY_COUNT;
     ...
     */
    public int groupPositionToBin(int groupPosition) {
        if (!mDataValid) return -1; 
    ...
    public String getLabel(int i){
        ...
        switch (i) {
        case 0:
            return resources.getString(R.string.history_today);
        
        case 1:
            return resources.getString(R.string.history_yesterday); 
            
        case 2:
            return resources.getString(R.string.history_last_week);
            
        case 3:
            return resources.getString(R.string.history_week_ago);       
