...
public abstract class BaseUi implements UI {
    ...
    private QuickNavigationScreenRight mQuickNavigationScreenRight;
    ...
    private ImageView home_left_image = null;
    private ImageView home_center_image = null;
    private ImageView home_right_image = null;
...
//                ((FrameLayout) mHomePage.findViewById(R.id.title_bar_layout)));
    ...
    public void SetSanyaHomepage() {
        ...
        if(mQuickNavigationScreen.getParent()!=null){
            quick_navigation.removeView(mQuickNavigationScreen);
        }
        quick_navigation.addView(mQuickNavigationScreen);
    }
