...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    private static final String[] SUGGEST_PROJECTION_BOOKMARK = new String[] {
    	Bookmarks._ID, Bookmarks.URL, Bookmarks.TITLE, Integer.toString(R.drawable.ic_bookmark_off_holo_dark),Bookmarks.DATE_MODIFIED
    };
    private static final String[] SUGGEST_PROJECTION_HISTORY = new String[] {
    	History._ID, History.URL, History.TITLE, Integer.toString(R.drawable.ic_history_holo_dark),History.DATE_LAST_VISITED
    };
...
//                SUGGEST_ORDER_BY, null);
    ...
    public int updateInTransaction(Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            ...
            case GLOBAL_INFO: {
            	db.update(TABLE_GLOBAL_INFO, values, selection, selectionArgs);
            	break;
            }
