...
public class NavTabView extends LinearLayout {
    ...
    protected void setWebView(Tab tab) {
        ...
        if(tab.isHomeTab() && tab.getOriginalUrl().length()==0 && tab.getUrl().length()==0){
            Bitmap cache = tab.getHomeTabCapture();
            image = Bitmap.createBitmap(cache, 0, 0, image.getWidth()*2, image.getHeight()*2);
