...
class FetchUrlMimeType extends Thread {
    ...
    private boolean another_ex_storage;

    public FetchUrlMimeType(Activity activity, boolean privateBrowsing,
            String uri, String userAgent, String referer, boolean another_ex_storage) {
        mContext = activity.getApplicationContext();
        mActivity = activity;
        mUri = uri;
        another_ex_storage = another_ex_storage;
        mReferer = referer;
    ...
    public void run() {
       ...
       mfilename = URLUtil.guessFileName(mUri, contentDisposition,
               mimeType);
       Intent intent = new Intent(mContext.getApplicationContext(), DownloadDialog.class);
       ...
       intent.putExtra("use_in", another_ex_storage);
