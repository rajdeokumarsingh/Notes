...
class Tab implements PictureListener {
    ...
    private void showError(ErrorDialog errDialog) {
        if (mInForeground) {
            AlertDialog d = new AlertDialog.Builder(mContext, AlertDialog.THEME_HOLO_LIGHT)
    ...
    private final WebViewClientClassicExt mWebViewClient = new WebViewClientClassicExt() {
        ...
        public void onFormResubmission(WebView view, final Message dontResend,
            ...
            mResend = resend;
            new AlertDialog.Builder(mContext, AlertDialog.THEME_HOLO_LIGHT).setTitle(
     ...
     */
    String getTitle() {
        if(mWebViewController.didUserStopLoading()){
        	return "";
        }
    ...
    public Bitmap getHomeTabCapture(){
        Activity activity = mWebViewController.getActivity();
        Bitmap cache = BitmapFactory.decodeResource(activity.getResources(), R.drawable.home_tab);
        return cache;
    }
