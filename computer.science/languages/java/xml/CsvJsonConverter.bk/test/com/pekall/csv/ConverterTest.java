...
public class ConverterTest extends TestCase {
   ...
   public void testParseEmptyLineCsv() throws Exception {
    ...
    public void testSingleUserNoDevice() throws Exception {
        String json = Converter.csv2Json(new String[]{
                "user1,password1,user1@aa.com,51302,fullName1,firstName1,lastName1,13800000000"
        });
        Debug.logVerbose(json);
    ...
    public void testSingleUserNoDevice2() throws Exception {
        String json = Converter.csv2Json(new String[]{
                "user1,password1,user1@aa.com,51302,fullName1,firstName1," +
                        "lastName1,13800000000,,,,"
        });
        Debug.logVerbose(json);
    ...
    private static final String SINGLE_USER_NO_DEVICE = "[{\"username\":\"user1\",\"password\":" +
            "\"password1\",\"email\":\"user1@aa.com\",\"type\":51302,\"firstName\":\"firstName1\"," +
            "\"lastName\":\"lastName1\",\"fullName\":\"fullName1\",\"phone\":\"13800000000\"," +
            "\"devices\":null}]";
