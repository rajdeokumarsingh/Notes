...
abstract class PayloadTestBase extends TestCase {
    ...
    abstract public void testParseAppXml() throws Exception;
    /* {
        Class clz = PayloadBluetoothPolicy.class;
        testParseAppXmlInternal(clz);
    } */

    private void testParseAppXmlInternal(Class clz) {
        PayloadBase policy = (PayloadBase) BeanBase.fromXmlT(
                TEST_APP_XML, clz);
    ...
    abstract public void testParseXml() throws Exception;
    /* {
        String type = PayloadBase.PAYLOAD_TYPE_BLUETOOTH_POLICY;
        testParseXmlInternal(type);
    } */

    private void testParseXmlInternal(String type) {
        ...
        assertEquals(parser.getPayload(type),
                getPolicy());
        assertTrue(ObjectComparator.equals(
                parser.getPayload(type), getPolicy()));
    }
