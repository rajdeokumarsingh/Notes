...
public class PayloadSecurityPolicyTest extends TestCase {
    ...
    public void testParseAppXml() throws Exception {
        PayloadSecurityPolicy policy = PayloadSecurityPolicy.fromXmlT(
                TEST_APP_XML, PayloadSecurityPolicy.class);
    ...
    public void testParseXml() throws Exception {
        ...
        assertEquals(parser.getPayload(PayloadBase.PAYLOAD_TYPE_SECURITY_POLICY),
                getPolicy());
        assertTrue(ObjectComparator.equals(
                parser.getPayload(PayloadBase.PAYLOAD_TYPE_SECURITY_POLICY), getPolicy()));
    }
    ...
    private PayloadBase getPolicy() {
        ...
        policy.setAllowGoogleCrashReport(false);
        policy.setAllowSDCard(false);
        policy.setAllowNonGoogleApp(PayloadSecurityPolicy.APP_USR_CONTROLLED);
        policy.setBackupMyData(PayloadSecurityPolicy.APP_ENABLED);
        policy.setDisableKeyguardFeatures(PayloadSecurityPolicy.KEYGUARD_FEATURE_CAMERA);
        return policy;
    }
    ...
    private static final String TEST_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "\t\t\t<key>allowSDCard</key>\n" +
            "\t\t\t<false/>\n" +
            "\t\t\t<key>disableKeyguardFeatures</key>\n" +
            "\t\t\t<string>camera</string>\n" +
            "\t\t\t<key>allowNonGoogleApp</key>\n" +
            "\t\t\t<string>user controlled</string>\n" +
            "\t\t\t<key>allowClipboard</key>\n" +
            "\t\t\t<true/>\n" +
            "\t\t\t<key>backupMyData</key>\n" +
            "\t\t\t<string>enabled</string>\n" +
            "\t\t\t<key>allowGoogleCrashReport</key>\n" +
            "\t\t\t<false/>\n" +
            "\t\t\t<key>allowFactoryReset</key>\n" +
            "\t\t\t<true/>\n" +
            "\t\t\t<key>PayloadType</key>\n" +
            "\t\t\t<string>com.pekall.security.policy</string>\n" +
            "\t\t\t<key>PayloadVersion</key>\n" +
            "\t\t\t<integer>1</integer>\n" +
            "\t\t\t<key>PayloadIdentifier</key>\n" +
            "\t\t\t<string>com.pekall.policy.security</string>\n" +
            "\t\t\t<key>PayloadUUID</key>\n" +
            "\t\t\t<string>3808D742-5D21-401E-B83C-AED1E990332D</string>\n" +
            "\t\t\t<key>PayloadDisplayName</key>\n" +
            "\t\t\t<string>Security配置</string>\n" +
            "\t\t\t<key>PayloadDescription</key>\n" +
            "\t\t\t<string>Security相关配置</string>\n" +
