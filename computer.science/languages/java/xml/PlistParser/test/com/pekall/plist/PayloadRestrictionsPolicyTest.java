...
public class PayloadRestrictionsPolicyTest extends TestCase {
    ...
    public void testTwoWay() throws Exception {
        ...
        assertEquals(profile.toXml(), TEST_XML);
    }

    private PayloadArrayWrapper createProfile() {
        PayloadArrayWrapper wrapper = createWrapper();
        wrapper.addPayLoadContent(createPasswordPolicy());
        wrapper.addPayLoadContent(createWifiConfig());
        wrapper.addPayLoadContent(createRestrictionsPolicy());
        return wrapper;
    }

    private PayloadRestrictionsPolicy createRestrictionsPolicy() {
        ...
        policy.setAllowAssistant(false);
        policy.setAllowCamera(false);
        policy.setAllowCloudBackup(true);
        policy.setAllowCloudDocumentSync(false);
        policy.setAllowGameCenter(false);
        policy.setAllowSafari(false);
        policy.setAllowiTunes(false);
        return policy;
    }
