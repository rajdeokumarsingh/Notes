...
public class SystemSettingsTest extends TestCase {
    ...
    public void testParseAppXml() throws Exception {
        SystemSettings settings = SystemSettings.fromXmlT(TEST_APP_XML, SystemSettings.class);
    ...
    public void testParseXml() throws Exception {
        ...
        assertEquals(parser.getPayload(PayloadBase.PAYLOAD_TYPE_SYSTEM_SETTINGS),
                getSettings());
        assertTrue(ObjectComparator.equals(
                parser.getPayload(PayloadBase.PAYLOAD_TYPE_SYSTEM_SETTINGS), getSettings()));
    }
