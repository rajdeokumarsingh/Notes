...
public class KeyFieldTranslation {
    private static final HashMap<String, String> field2Key = new HashMap<String, String>();
    private static final HashMap<String, String> key2field = new HashMap<String, String>();
    static {
