package com.java.examples.sqlparser;
...
public class Helper {
    ...
    public static void validateSelection(String selection, Set<String> allowedColumns) {
        Log.d(Constants.TAG, "selection: " + selection);
        StringBuilder sb = new StringBuilder();
        for (String s : allowedColumns) {
            sb.append(s + ", ");
        }
        Log.d(Constants.TAG, "allowedColumns: " + sb.toString());
        ...
        try {
            ...
            if (Constants.LOGV) {
                ...
                Log.d(Constants.TAG, "allowedColumns: " + allowedColumns);
            } else if (false) {
