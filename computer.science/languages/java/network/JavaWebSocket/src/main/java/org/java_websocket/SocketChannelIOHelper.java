...
public class SocketChannelIOHelper {
	...
	/**
	 * @see org.java_websocket.WrappedByteChannel#readMore(java.nio.ByteBuffer)
	 * @return returns whether there is more data left which can be obtained via {@link #readMore(java.nio.ByteBuffer, org.java_websocket.WebSocketImpl, org.java_websocket.WrappedByteChannel)}
	 **/
