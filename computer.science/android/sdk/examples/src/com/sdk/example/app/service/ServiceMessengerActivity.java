...
public class ServiceMessengerActivity {
	public static final boolean ENABLE_LOG = true;
	public static final String LOGTAG = "ServiceMessengerActivity";
	...
	public static class Binding extends Activity {
		...
		private ServiceConnection mConnection = new ServiceConnection() {
			...
			public void onServiceConnected(ComponentName className,
				...
				try {
					...
					msg = Message.obtain(null, ServiceMessenger.MSG_SET_VALUE,
							this.hashCode(), 0);
					mService.send(msg);
		...
		void doBindService() {
			if (ENABLE_LOG)
				Log.v(LOGTAG, "enter doBindService4()");

			// Establish a connection with the service. We use an explicit
			// class name because there is no reason to be able to let other
			// applications replace our component.

			// bindService(new Intent(Binding.this, ServiceMessenger.class),
			// mConnection, Context.BIND_AUTO_CREATE);
			Intent intent = new Intent();
//			intent.setClassName("com.sdk.example.app.service",
//					"com.sdk.example.app.service.ServiceMessenger");
			intent.setClassName(this, "com.sdk.example.app.service.ServiceMessenger");
